...
export default function OrgAdminLibraryPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1">Documents shared with your organisation.</p>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button onClick={fetchCollections} className="p-2 rounded-xl border border-calm-200 dark:border-slate-600 hover:bg-calm-50 dark:hover:bg-slate-700 transition-colors text-slate-500 dark:text-slate-400" title="Refresh">
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-slate-500 dark:text-slate-400 font-medium">
            {search ? 'No collections match your search.' : 'No document collections available for your organisation yet.'}
          </p>
        </div>
      ) : (
            ...
            >
              {col.thumbnailUrl ? (
                ...
                <div className="h-36 bg-calm-50 dark:bg-slate-700 flex items-center justify-center">
                  <FolderOpen className="h-14 w-14 text-slate-300 dark:text-slate-500 group-hover:text-emerald-400 transition-colors" />
                </div>
              )}
              <div className="p-4">
                <div className="flex items-start justify-between gap-2">
                  <h3 className="font-semibold text-slate-800 dark:text-slate-200 leading-snug line-clamp-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                    {col.title}
                  </h3>
                  <ChevronRight className="h-4 w-4 text-slate-300 dark:text-slate-600 flex-shrink-0 mt-0.5 group-hover:text-emerald-400 transition-colors" />
                </div>
