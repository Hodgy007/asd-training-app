    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1">
          Documents shared with your organisation. Download guides, templates, and resources.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-slate-500 dark:text-slate-400 font-medium">
            {search ? 'No documents match your search.' : 'No documents available for your organisation yet.'}
          </p>
          {search && (
            <button
              onClick={() => setSearch('')}
              className="text-emerald-600 dark:text-emerald-400 text-sm font-medium mt-2 hover:underline"
            >
              Clear search
            </button>
          )}
                ...
                <div className="p-4 flex-1 flex flex-col gap-2">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-calm-100 dark:border-slate-700 mt-auto">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 text-xs font-semibold hover:bg-emerald-100 dark:hover:bg-emerald-900/50 transition-colors"
                    >
