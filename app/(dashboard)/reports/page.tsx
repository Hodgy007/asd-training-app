  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-amber-700 mt-0.5">
            ...
            Observations were recorded by a caregiver using the Ambitious about Autism tool.
          </p>
        </div>
      </div>
      ...
      <div className="hidden print:block text-center text-xs text-slate-400 mt-8 pt-4 border-t">
        <p>Generated by Ambitious about Autism Caregiver Tool &middot; {format(new Date(), 'dd MMMM yyyy')}</p>
