  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-amber-700 mt-0.5">
            ...
            Observations were recorded by a caregiver using the ASD Awareness UK tool.
          </p>
        </div>
      </div>
              ...
              <div className="border-b border-calm-200 pb-4">
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right no-print">
                    <p className="text-xs text-slate-400">ASD Awareness UK</p>
                  </div>
                </div>
                {child.notes && (
                  <p className="text-sm text-slate-600 mt-3 bg-calm-50 rounded-xl p-3">
                    <strong>Caregiver notes:</strong> {child.notes}
                  </p>
                )}
              </div>
      ...
      <div className="hidden print:block text-center text-xs text-slate-400 mt-8 pt-4 border-t">
        <p>Generated by ASD Awareness UK Caregiver Tool &middot; {format(new Date(), 'dd MMMM yyyy')}</p>
