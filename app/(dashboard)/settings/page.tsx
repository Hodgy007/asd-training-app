...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-page-enter">
      ...
      {/* Change Password — only for users with a password (not SSO-only) */}
      ...
      <div className="card border-2 border-red-200 space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Permanently deletes your account and all associated data including training progress. <strong>This cannot be undone.</strong>
          </p>
        </div>
