        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              // Vercel Blob client SDK calls vercel.com/api/blob to coordinate
              // uploads, then PUTs to *.public.blob.vercel-storage.com. Both
              // hosts are required for the SCORM import modal's client-direct
              // upload path (which bypasses the 4.5 MB serverless body limit).
              "connect-src 'self' https://generativelanguage.googleapis.com https://api.stripe.com https://vercel.com https://blob.vercel-storage.com https://*.public.blob.vercel-storage.com",
