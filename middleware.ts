...
const PUBLIC_PATHS = ['/login', '/forgot-password', '/reset-password', '/register-organisation', '/privacy', '/terms', '/api/auth', '/api/organisations/register', '/api/cron', '/courses', '/api/checkout/session', '/api/stripe/webhook', '/api/courses/free-claim']
